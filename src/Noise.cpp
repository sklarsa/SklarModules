...
NoiseWidget::NoiseWidget()
{
    ...
    addInput(createInput<PJ301MPort>(Vec(33, 70), module, Noise::CV_INPUT));
    addInput(createInput<PJ301MPort>(Vec(33, 105), module, Noise::TRIGGER_INPUT));

    addOutput(createOutput<PJ301MPort>(Vec(33, 185), module, Noise::NOISE_OUTPUT));
    addOutput(createOutput<PJ301MPort>(Vec(33, 225), module, Noise::SH_OUTPUT));

    addChild(createLight<MediumLight<YellowLight>>(Vec(41, 275), module, Noise::TRIGGER_LIGHT));
}
